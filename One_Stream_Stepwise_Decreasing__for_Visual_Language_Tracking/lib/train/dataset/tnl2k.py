...
class Tnl2k(BaseVideoDataset):
    ...
    def get_sequence_info(self, seq_id):
        ...
        visible = valid.byte()
        # vis = torch.tensor(1)
        # visible = self._read_target_visible(seq_path) & valid.to(torch.bool)
        # visible = vis & visible.byte()
    ...
    def _get_frame_path(self, seq_path, frame_id):
        ...
        path_list = os.listdir(os.path.join(seq_path, 'frames'))
        ...
        return os.path.join(seq_path, 'frames', path_list[frame_id - 1])
